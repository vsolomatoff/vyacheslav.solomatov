...
public class MyCompletableFuture {
    ...
    public static void runAsyncExample() throws Exception {
        ...
        iWork();
        System.out.println("gtt.get(): " + gtt.get());
    }
    ...
    public static void thenAcceptExample() throws Exception {
        ...
        iWork();
        System.out.println("Куплено и убрано в холодильник: " + bm.get());
    }
    ...
    public static void thenCombineExample() throws Exception {
        CompletableFuture<String> result = buyProduct("Молоко").thenCombine(buyProduct("Хлеб"), (r1, r2) -> "Куплены " + r1 + " и " + r2);
        iWork();
    ...
    public static void allOfExample() throws Exception {
        CompletableFuture<Void> all = CompletableFuture.allOf(washHands("Папа"), washHands("Мама"), washHands("Ваня"), washHands("Боря"));
    ...
    public static void anyOfExample() throws Exception {
        CompletableFuture<Object> first = CompletableFuture.anyOf(whoWashHands("Папа"), whoWashHands("Мама"), whoWashHands("Ваня"), whoWashHands("Боря"));
